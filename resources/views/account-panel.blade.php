<ul id="account-panel" class="nav nav-pills flex-column" >
    ...
    <li class="nav-item">
        <a href="/myorders"  class="nav-link font-weight-bold" role="tab" aria-controls="tab-register" aria-expanded="false"><i class="fas fa-shopping-bag"></i>My Orders</a>
    </li>
    <li class="nav-item">
    ...
    <li class="nav-item">
        <a href="/logout" class="nav-link font-weight-bold" role="tab" aria-controls="tab-register" aria-expanded="false"><i class="fas fa-sign-out-alt"></i> Logout</a>
    </li>
</ul>