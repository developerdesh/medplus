...
<div class="container w-75" style="height: 50%;">
    ...
    <div class="main-content">
        <!-- Header -->
            ...
            <!-- Form -->
            <form class="user-form" method="post" action="/newadminbackend">
                @csrf
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-select form-select-lg mb-3" aria-label=".form-select-lg example" id="role" name="role" required>
