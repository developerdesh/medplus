...
<div class="container w-75" style="height: 50%;">
    ...
    <div class="main-content">
        <!-- Header -->
            ...
            <!-- Form -->
            <form class="user-form" method="post" action="/editauserbackend">
                @csrf
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" id="role" class="form-control" placeholder="Name" name="name" required value="{{$data['name']}}">
                        @error('name')
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="email" id="email" class="form-control" placeholder="Email" name="email" required value="{{$data['email']}}">
                        @error('email')
                        <span style="color:red!important">
                        {{$message}}</span>
                        @enderror
